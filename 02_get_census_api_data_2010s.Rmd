...
```{r}
county_codes_tens <- read.csv("data/county_codes/county_codes.csv")
```

```{r}

county_codes_tens$county <- county_codes_tens$county %>%
  str_sub(3,5)


View(county_codes_tens)
...
acs_data_tens_join <-
        inner_join(acs_data_tens_join, county_codes_tens, by = "county", copy = FALSE)
